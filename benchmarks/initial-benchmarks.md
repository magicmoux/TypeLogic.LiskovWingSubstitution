...
|------------------:|----------------:|----------:|-----------:|------------:|----:|--------------:|
| IsVariantOf Uncached (baseline) - .NET 4.6.2 | .NET Framework 4.6.2 | 451,422 ns | 30,776 ns | 1,686.9 ns | 0.0610 | 802 B |
| IsVariantOf Cached - .NET 8.0 | .NET 8.0 | 9.187 ns | 1.1506 ns | 0.0631 ns | 0.0043 | 56 B |
